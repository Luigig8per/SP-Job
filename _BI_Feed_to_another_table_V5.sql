USE [DGSDATA]
GO
/****** Object:  StoredProcedure [dbo].[_BI_Feed_2_another_table_mod_v5]    Script Date: 11/23/2017 3:18:58 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

ALTER PROCEDURE [dbo].[_BI_Feed_2_another_table_mod_v5] 
...
set @Today= CAST(DATEADD(day,0, GETDATE()) AS DATE) 
...
where ([IdWager]>678395) and (not EXISTS  ( select *  from [G8Apps].[dbo].[_prueba_luis_temp_BI_WL] as p where p.IdWager = IdWager ))

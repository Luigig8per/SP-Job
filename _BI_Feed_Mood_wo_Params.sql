USE [DGSDATA]
GO
/****** Object:  StoredProcedure [dbo].[_BI_Feed_Mood_wo_Params]    Script Date: 11/20/2017 4:36:28 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

ALTER PROCEDURE [dbo].[_BI_Feed_Mood_wo_Params] 
...
INSERT INTO [dbo].[_prueba_luis_temp_BI_WL]
...
TEAM = (
	...
	END	
		...
		END),
					...
					where (X.[IdWager]>678395) 	and (X.[IdWager] NOT IN (select IdWager from [G8Apps].[dbo].[_prueba_luis_temp_BI_WL] )) 
)							 
AS summary

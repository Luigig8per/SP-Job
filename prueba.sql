USE [DGSDATA]
GO
/****** Object:  StoredProcedure [dbo].[_BI_Feed_to_run]    Script Date: 11/20/2017 6:34:43 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

ALTER PROCEDURE [dbo].[_BI_Feed_to_run] 
...
set @Day1 =CAST(DATEADD(day,0, GETDATE()) AS DATE) 
...
values(@Betsidentifier.IdWager,
[@Betsidentifier.IdWagerDetail],
@Betsidentifier.IdAgent,
@Betsidentifier.Agent,
[@Betsidentifier.IdPlayer],
[@Betsidentifier.Player],
[@Betsidentifier.IdLineType],
@Betsidentifier.LineTypeName,
[@Betsidentifier.LoginName],
[@Betsidentifier.WinAmount],
[@Betsidentifier.RiskAmount],
[@Betsidentifier.Result],
[@Betsidentifier.Net],
@Betsidentifier.GamePeriod,
@Betsidentifier.LEAGUE,
[@Betsidentifier.CompleteDescription],
[DetailDescription],
@Betsidentifier.TEAM,
[@Betsidentifier.IdGame],
[@Betsidentifier.IdLeague],
[@Betsidentifier.Period],
[@Betsidentifier.Play],
@Betsidentifier.WagerPlay,
@Betsidentifier.FAV_DOG,
[@Betsidentifier.IdSport],
[@Betsidentifier.PlacedDate],
[@Betsidentifier.SettledDate],
[@Betsidentifier.Odds],
[@Betsidentifier.Points],
[@Betsidentifier.Score],	
--[ResultDetail],
[@Betsidentifier.IP],
@Betsidentifier.OpeningPoints,
@Betsidentifier.OpeningMoneyLine,
@Betsidentifier.ClosingPoints,
@Betsidentifier.ClosingMoneyLine,
@Betsidentifier.BeatLine)
